...
uint256 hashGenesisBlock("0xa1b72a4ede310a772b18514f48b9a5b10e06f2ad14c0d1fea411af6218871f63");
...
{
    int64 nSubsidy = 99 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 60 * 60; // 1 hour
static const int64 nTargetSpacing = 99; // 99 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal BuyCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BuyCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa1b72a4ede310a772b18514f48b9a5b10e06f2ad14c0d1fea411af6218871f63");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "BuyCoin is finally released";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x7e8a39493995894c5031a0f5ca4ce5332850602aeed9390c0394b1f813e01627"));
